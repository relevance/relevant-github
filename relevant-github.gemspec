...
Gem::Specification.new do |s|
  s.name = %q{relevant-github}
  s.version = "0.0.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Jared Pace", "Rob Sanheim"]
  s.date = %q{2010-10-08}
  s.description = %q{Parses github activity feeds}
  ...
  s.homepage = %q{http://github.com/relevance/relevant-github}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{Github commit widget for Relevant}
  s.test_files = [
    "spec/relevant/github_spec.rb",
     "spec/spec_helper.rb"
  ]
